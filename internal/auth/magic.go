...
// --- Temporary helpers (flyttes til delt cookie-helper i Task 10/11) ---

// ClientIP wraps audit.ExtractIP — proper plumbing in Task 10.
...
func setAuthCookies(w http.ResponseWriter, svc *gen.Service, accessToken, refreshToken string) {
	http.SetCookie(w, &http.Cookie{
		Name: svc.JwtCookieName, Value: accessToken, Path: "/",
